...
class PlayerGUI:
  def __init__(self, room_frame, x, y):
    ...
    lb_player_name = Label(player_frame, text="Test Player Name", anchor="center")
    lb_player_stack = Label(player_frame, text="Test Player Stack")
    lb_player_seat = Label(player_frame, text="Test Player Seat", anchor="center")

    card_one_frame.grid(row=0,column=0)
    card_two_frame.grid(row=0,column=1)
    lb_player_name.grid(row=1, column=0, columnspan=2)
    lb_player_stack.grid(row=2, column=0, columnspan=2)
    lb_player_seat.grid(row=3, column=0, columnspan=2)
...
def gui():
  ...
  for x, y in coord_list:
    player_gui_list.append(PlayerGUI(room_frame, x, y))
